 ...
 */
class RNCameraKitModule(private val reactContext: ReactApplicationContext) : NativeCameraKitModuleSpec(reactContext), ActivityEventListener {
    ...
    @ReactMethod
    override fun scanFromUri(uri: String, options: ReadableMap?, promise: Promise) {
        try {
    ...
    @ReactMethod
    override fun pickAndScan(options: ReadableMap?, promise: Promise) {
